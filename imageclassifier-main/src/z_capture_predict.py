...
import os
import cv2
from z_utils_predict import write_image, key_action, init_cam, write_text_cam, get_predicted_label
...
if __name__ == "__main__":
    ...
    model = tf.keras.models.load_model('../models/M3_rock_mineral_transfer.h5')
            ...
            if pred_mode:
                ...
                if frame_count % 30 == 0:
                    pred_class = get_predicted_label(
                        ...
                        #classes=os.listdir('../data/web_predict')) 
                        #classes = ['amethyst', 'ammonite', 'aventurin', 'empty_space', 'obsidian']
                        classes=os.listdir('../data/original'))
